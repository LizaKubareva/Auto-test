...
import time
from src.FirsPage.FirstPage import FirstPage

s = Service("E:\\Worck\\Auto-test\\drivers\\windows\\chromedriver.exe")
...
try:
    for url in urls:
        ...
        first_page.testButtonGetMyPlan()
        ...
        # close_z.click()
        # time.sleep(3)
        # button_s = browser.find_element("xpath", '/html/body/div[4]/div[1]/section[9]/div/div/div[1]/a')
        # button_s.click()
        # time.sleep(3)
